...
public final class inicio_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <!--El script lo puse aqui porque no me cargaba desde un archivo externo, no se porque, luego lo checo-->\n");
      out.write("        <script>\n");
      out.write("            $(document).ready(function() {\n");
      out.write("                /*autocomplete es una funcion de jquery ui para hacer las cosas mas faciles*/\n");
      out.write("                $(\"#search\").autocomplete({     \n");
      out.write("                    source : function(request, response) {\n");
      out.write("                        /*Esto es para la barra de busqueda*/\n");
      out.write("                        $.ajax({\n");
      out.write("                            url : \"http://localhost:8080/StrongFit/sBusqueda\",\n");
      out.write("                            type : \"post\",\n");
      out.write("                            dataType : \"json\",\n");
      out.write("                            data : {\n");
      out.write("                                info : request.term\n");
      out.write("                            },             \n");
      out.write("                            success : function(respuesta) {\n");
      out.write("                                    console.log(\"********Regreso algo******\");\n");
      out.write("                                    console.log(respuesta);\n");
      out.write("                                    response(respuesta);\n");
      out.write("                            }\n");
      out.write("                        });\n");
      out.write("                    }\n");
      out.write("                });\n");
    ...
    String dom = conecta.getDominio();
      ...
      out.write("                    <span class = \"search\"><input type=\"text\" id=\"search\" name=\"search\" class=\"search\"></span>\n");
      out.write("                </p>\n");
