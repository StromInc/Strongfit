 ...
 * @author ian
 */
@WebServlet(name = "sBorrarDieta", urlPatterns = {"/sBorrarDieta"})
public class sBorrarDieta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ResultSet rs = conecta.spBorrarDieta(idDieta, idUser);
            while(rs.next()){
                ResultSet dias = conecta.spBorrarDia(rs.getInt("idDia"));
                while(dias.next()){
                    ResultSet rel = conecta.spBorrarComida(dias.getInt("idComidas"), idDieta);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(sBorrarDieta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
