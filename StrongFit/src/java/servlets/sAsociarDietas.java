 ...
 * @author ian
 */
@WebServlet(name = "sAsociarDietas", urlPatterns = {"/sAsociarDietas"})
public class sAsociarDietas extends HttpServlet {
...
//            }
            ...
            if(rs.next()){
                if(!rs.getString("resultado").equals("no")){
                    Map<String, Object> mapa = new HashMap();
                    mapa.put("estado", "listo");
                    write(response, mapa);
                }
            }
        }
